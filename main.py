...
# uncomment the line below to retrain the CNN model
# remember to comment assign acc_B1_train to 'TBD' if this line is uncommented
# print("Training CNN for task B1, this is going to take some time")
# acc_B1_train = B1_train(200, x_train_faceshape, y_train_faceshape, x_test_faceshape, y_test_faceshape, B1_model_name)
acc_B1_train = 'TBD'
...
# uncomment the line below to retrain the CNN model
# remember to comment assign acc_B2_train to 'TBD' if this line is uncommented
# print("Training CNN for task B2, this is going to take some time")
# acc_B2_train = B2_train(500, x_train_eyecolour, y_train_eyecolour, x_test_eyecolour, y_test_eyecolour, B2_model_name)
acc_B2_train = 'TBD'
